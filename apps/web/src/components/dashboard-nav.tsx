...
const navGroups: NavGroup[] = [
  {
    title: "العمليات",
    items: [
      { href: "/dashboard", label: "لوحة التحكم", icon: "01" },
      { href: "/screening/new", label: "فحص جديد", icon: "02" },
      { href: "/dashboard/screening/logs", label: "سجلات الفحص", icon: "03" },
      { href: "/screening/bulk", label: "فحص جماعي", icon: "04" },
      { href: "/screening/document-extraction", label: "استخراج المستندات", icon: "05" },
      { href: "/cases", label: "الحالات", icon: "06" },
    ],
  },
  {
    title: "المصادر",
    items: [
      { href: "/dashboard/sources", label: "مصادر البيانات", icon: "11" },
      { href: "/dashboard/sources/ofac", label: "OFAC", icon: "12" },
      { href: "/dashboard/sources/ofac/local-lists", label: "القوائم المحلية", icon: "13" },
      { href: "/dashboard/sources/ofac/downloads", label: "تنزيلات OFAC", icon: "14" },
      { href: "/dashboard/sources/ofac/sync", label: "مزامنة OFAC", icon: "15" },
      { href: "/dashboard/inquiries", label: "الاستفسارات", icon: "16" },
    ],
  },
  {
    title: "الإدارة",
    items: [
      { href: "/admin/users", label: "المستخدمون", icon: "18" },
      { href: "/dashboard/admin/notaries", label: "كتاب العدل ومفاتيح API", icon: "19" },
      { href: "/admin/data-sources", label: "مصادر البيانات", icon: "20" },
      { href: "/admin/audit-logs", label: "سجلات التدقيق", icon: "21" },
      { href: "/admin/system-health", label: "صحة النظام", icon: "22" },
      { href: "/dashboard/admin/monitoring", label: "مراقبة النظام", icon: "23" },
    ],
  },
];
